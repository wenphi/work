...
void sendHook0()
{
    messageClient *client0 = new messageClient(taddress, "Client1sendHook0", 1000);
    int count = 0;
    //发送
    std::string msg = "hello,i'am Client1 sendHook0";
...
void sendHook1()
{
    messageClient *client0 = new messageClient(taddress, "Client1sendHook1", 1000);
    int count = 0;
    //发送
    std::string msg = "hello,i'am Client1 sendHook1";
...
void sendHook2()
{
    messageClient *client0 = new messageClient(taddress, "Client1sendHook2", 1000);
    int count = 0;
    //发送
    std::string msg = "hello,i'am Client1 sendHook2";
    Json::Value jsonDate;
    Json::Value jsonReply;
    int flag;
    while (!stopFlag)
